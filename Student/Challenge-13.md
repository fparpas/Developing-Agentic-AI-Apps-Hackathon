...
In this challenge, you'll learn how to use Azure API Center to maintain an inventory (registry) of remote Model Context Protocol (MCP) servers and help stakeholders discover them using the API Center portal. MCP servers expose backend APIs or data sources in a standardized way to AI agents and models that consume them.
...
- **APIs** - The core API definitions that represent your API assets, including MCP servers
- **Versions** - Different versions of your APIs with their own specifications and metadata
...
The API Center portal provides a developer-friendly interface for discovering and exploring APIs in your organization's inventory. It enables:

- **Self-service Discovery** - Developers can browse and search for APIs independently
- **API Documentation** - Access to comprehensive API specifications and documentation
- **Environment Information** - View deployment details across different environments
- **Access Management** - Control who can view and access specific APIs
...
2. Configure the API Center with appropriate naming and resource group
