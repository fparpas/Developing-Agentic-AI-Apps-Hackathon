# Challenge 11 - Python - Build Agentic RAG with Azure AI Search

[< Previous Challenge](./Challenge-10-python.md) - **[Home](../README.md)** - [Next Challenge >](./Challenge-12.md)

[![](https://img.shields.io/badge/C%20Sharp-lightgray)](Challenge-11-csharp.md)
[![](https://img.shields.io/badge/Python-blue)](Challenge-11-python.md)
...
You'll work with the [starter project](./Resources/Challenge-11/python). The conversational interface is already implemented; your objective is to complete the core agentic retrieval workflow powered by Azure AI Search.
