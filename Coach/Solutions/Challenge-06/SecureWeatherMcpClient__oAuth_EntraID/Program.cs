...
class Program
{
    ...
    public static async Task Main(string[] args)
    {
        try
        {
            ...
            //Validate Azure AD settings for OAuth
            if (string.IsNullOrEmpty(clientId) || string.IsNullOrEmpty(clientSecret))
            {
                Console.WriteLine("Warning: Azure AD configuration is incomplete. Please update appsettings.json");
                Console.WriteLine("You can also embed the settings directly into the code above.");
            ...
            else
            {
                ...
                var authService = new EntraIdAuthService(clientId, clientSecret, tenantId, scopes );
