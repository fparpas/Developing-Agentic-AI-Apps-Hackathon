...
/// </summary>
[McpServerToolType]
[Description("Comprehensive flight operations including search, booking, and management")]
public class FlightTools
{
    #region Flight Search Operations

    [McpServerTool]
    [Description("[FLIGHT] Search for flight offers with comprehensive filtering options")]
    public static async Task<object> FlightSearchFlightOffers(
        ...
        [Description("Maximum number of offers to return (default: 250)")] int max = 250)
    {
    ...
    [McpServerTool]
    [Description("[FLIGHT] Get cheapest flight dates for flexible travel planning")]
    public static async Task<object> FlightCheapestDateSearch(
        AmadeusHttpClient httpClient,
    ...
    public static async Task<object> FlightInspirationSearch(
        AmadeusHttpClient httpClient,
        [Description("Origin IATA code (e.g., NYC, LON)")] string origin,
        [Description("Departure date (YYYY-MM-DD format)")] string departureDate,
        [Description("Return date (YYYY-MM-DD format) - optional")] string? returnDate = null,
    ...
    public static async Task<object> FlightOffersPrice(
        AmadeusHttpClient httpClient,
    ...
    [McpServerTool]
    [Description("[FLIGHT] Search for flight availability with specific criteria")]
    public static async Task<object> FlightAvailabilitySearch(
        AmadeusHttpClient httpClient,
        [Description("Origin IATA code (e.g., NYC, LON)")] string originLocationCode,
        [Description("Destination IATA code (e.g., PAR, BKK)")] string destinationLocationCode,
        [Description("Departure date (YYYY-MM-DD format)")] string departureDate,
    ...
    public static async Task<object> FlightDelayPrediction(
        AmadeusHttpClient httpClient,
        [Description("Origin IATA code (e.g., NYC, LON)")] string originLocationCode,
        [Description("Destination IATA code (e.g., PAR, BKK)")] string destinationLocationCode,
        [Description("Departure date (YYYY-MM-DD format)")] string departureDate,
    ...
    public static async Task<object> FlightChoicePrediction(
        AmadeusHttpClient httpClient,
    ...
    public static async Task<object> FlightCreateOrder(
        AmadeusHttpClient httpClient,
    ...
    public static async Task<object> FlightGetOrder(
        AmadeusHttpClient httpClient,
    ...
    public static async Task<object> FlightSeatMapDisplay(
        AmadeusHttpClient httpClient,
        [Description("Flight offer data (JSON string)")] string flightOfferData)
    {
        try
    ...
    public static async Task<object> FlightCheckInLinks(
        AmadeusHttpClient httpClient,
